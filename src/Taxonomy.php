...
class Taxonomy
{
	...
	function custom_taxonomy()
	{
		...
		$labels = array(
			'name'                       => _x('Blood Group', 'ection Name', 'text_domain'),
			'singular_name'              => _x('Blood Group', 'Blood Group Name', 'text_domain'),
			'menu_name'                  => __('Blood Group', 'text_domain'),
			'all_items'                  => __('All Blood Group', 'text_domain'),
			'parent_item'                => __('Parent Blood Group', 'text_domain'),
			'parent_item_colon'          => __('Parent Blood Group:', 'text_domain'),
			'new_item_name'              => __('New Blood Group Name', 'text_domain'),
			'add_new_item'               => __('Add Blood Group', 'text_domain'),
			'edit_item'                  => __('Edit Blood Group', 'text_domain'),
			'update_item'                => __('Update Blood Group', 'text_domain'),
			'view_item'                  => __('View Blood Group', 'text_domain'),
			'separate_items_with_commas' => __('Separate type with commas', 'text_domain'),
			'add_or_remove_items'        => __('Add or remove section', 'text_domain'),
			'choose_from_most_used'      => __('Choose from the most used', 'text_domain'),
			'popular_items'              => __('Popular Blood Group', 'text_domain'),
			'search_items'               => __('Search Blood Group', 'text_domain'),
			'not_found'                  => __('Not Found', 'text_domain'),
			'no_terms'                   => __('No section', 'text_domain'),
			'items_list'                 => __('Blood Group list', 'text_domain'),
			'items_list_navigation'      => __('Blood Group list navigation', 'text_domain'),
		);
		$args = array(
			'labels'                     => $labels,
			'hierarchical'               => true,
		...
		register_taxonomy('bloodgroup', 'user', $args);
	}
}
